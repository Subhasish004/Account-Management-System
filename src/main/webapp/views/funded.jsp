...
<div class="container login-container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-10">
        	...
        	<center><h4>${msg}</h4><br></center>

             </div>

                <div class="card-body">

                  <p style="font-weight: bold; font-size: 28px; margin-left: 10px;">${transaction.bankAccount.customer.firstName} </p>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><fmt:formatDate value="${transaction.time}" pattern="yyyy-MM-dd HH:mm:ss.SSS"/></td>
